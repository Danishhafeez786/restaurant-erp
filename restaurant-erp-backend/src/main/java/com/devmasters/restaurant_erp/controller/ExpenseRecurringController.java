...
import com.devmasters.restaurant_erp.handler.ExpenseRecurringHandler;
...
public class ExpenseRecurringController {
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.<Void>builder()
                        .success(true)
                        .message(
                                "Expense Recurring Deleted Successfully")
                        .build());
    }
    ...
    public ResponseEntity<ApiResponse<Void>> restore(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.<Void>builder()
                        .success(true).message("Expense Recurring Restored Successfully").build());
    }
