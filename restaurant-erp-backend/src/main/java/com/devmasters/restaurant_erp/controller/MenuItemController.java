...
import com.devmasters.restaurant_erp.handler.MenuItemHandler;
...
public class MenuItemController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<MenuItemModel>> create(@RequestBody MenuItemModel model) {
    ...
    public ResponseEntity<ApiResponse<PageResponse<MenuItemModel>>> search(
        ...
        return ResponseEntity.ok(
                ApiResponse.<PageResponse<MenuItemModel>>builder()
                        ...
                        .data(menuItemHandler.getAll(criteria, pageable))
                        .build()
        );
    }
